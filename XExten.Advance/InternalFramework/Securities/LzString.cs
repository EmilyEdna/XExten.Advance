...
namespace XExten.Advance.InternalFramework.Securities
{
    internal class LzString
    {
        ...
        internal static string CompressToBase64(string input)
        {
        ...
        internal static string DecompressFromBase64(string input)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
        ...
        internal static string CompressToUTF16(string input)
        {
            return Compress(input, 15, code => (char)(code + 32));
        }

        internal static string DecompressFromUTF16(string input)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
        ...
        internal static string CompressToEncodedURIComponent(string input)
        {
        ...
        internal static string DecompressFromEncodedURIComponent(string input)
        {
            if (input == null) throw new ArgumentNullException(nameof(input));
        ...
        internal static byte[] CompressToUint8Array(string uncompressed)
        {
        ...
        internal static string DecompressFromUint8Array(byte[] compressed)
        {
        ...
        internal static string Compress(string uncompressed)
        {
        ...
        internal static string Decompress(string compressed)
        {
            if (compressed == null) throw new ArgumentNullException(nameof(compressed));
