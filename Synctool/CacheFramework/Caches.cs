...
using Synctool.CacheFramework.MongoDbCache;
using Synctool.CacheFramework.RedisCache;
using Synctool.CacheFramework.RunTimeCache;
using Synctool.LinqFramework;

namespace Synctool.CacheFramework
{
    /// <summary>
    ///
    /// </summary>
